    ...
    return(
        ...
        data-navbar-theme="dark"
         className="w-full bg-[#0E0D18]  flex flex-col max-md:px-5 md:justify-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:px-26 px-10 py-18 justify-items-center md:justify-items-stretch" data-navbar-theme="white">
                    <img src={card1}/>
                    <img src={card2}/>
                    <img src={card3}/>
                    <img src={card4}/>
