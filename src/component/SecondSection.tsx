...
const SecondSection = () => {
    return(
        <div
         ...
         className="flex flex-row justify-center gap-3 px-20 mt-30 font-manrope mb-30 ">
         <div className="flex flex-col gap-3">
            <div className="bg-[#FCFAFF] w-75.5 h-72.5 rounded-[20px] py-5 ">
