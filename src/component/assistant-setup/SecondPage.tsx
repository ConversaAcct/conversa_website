...
import card from "../../assets/assistant-setup/secondpage/img (6).png"

const SecondPage = () => {
    return (
        <div className="flex lg:flex-row flex-col lg:justify-between lg:px-30 md:px-20 py-10 border-t border-[#F7F5F1]"  data-navbar-theme="white">
            ...
            <div className="max-lg:mt-5 max-md:px-5">
                  <img src={card} className=" md:w-150 md:h-110 w-140 h-90"/>
            </div>
