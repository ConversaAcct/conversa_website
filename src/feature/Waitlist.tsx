  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        ...
        aria-haspopup="listbox"
        aria-expanded={open}
        className={`flex w-full items-center justify-between text-[14px] rounded-lg border bg-white px-4 py-2 text-left outline-none transition-colors ${
          open
            ? "border-violet-500 focus:border-[#5B0AFF]"
            : "border-[#94A3B8]"
        } ${value ? "text-[#1F2937]" : "text-[#9498B8]"}`}
        ...
        >
          <div className="dropdown-scrollbar max-h-60 overflow-y-auto py-2">
            ...
            <button
              ...
              className={`flex w-full items-center gap-3 px-4 py-2.5 text-left text-[14px] transition-colors cursor-pointer ${
                value === FEATURED_COUNTRY
                  ? "bg-[#F3EDFF] font-medium text-[#5B0AFF]"
                  : "text-[#1F2937] hover:bg-[#F3EDFF] hover:text-[#5B0AFF]"
              }`}
            >
            ...
            {restOptions.map((option) => {
              ...
              return (
                <button
                  ...
                  className={`flex w-full items-center gap-3 border-t border-gray-100 px-4 py-2.5 text-left transition-colors cursor-pointer text-[14px] ${
                    selected
                      ? "bg-[#F3EDFF] font-medium text-[#5B0AFF]"
                      : "text-[#1F2937] hover:bg-[#F3EDFF] hover:text-[#5B0AFF]"
                  }`}
            ...
            {hasOther && (
              <button
                ...
                className={`flex w-full items-center border-t border-gray-100 px-4 py-2.5 text-left transition-colors cursor-pointer text-[14px] ${
                  value === "Other"
                    ? "bg-[#F3EDFF] font-medium text-[#5B0AFF]"
                    : "text-[#1F2937] hover:bg-[#F3EDFF] hover:text-[#5B0AFF]"
                }`}
